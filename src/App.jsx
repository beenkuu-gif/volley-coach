...
const BASE_TABS = [
  ...
  { id: 'attendance', label: 'Obecności',  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5"/></svg> },
...
export default function App() {
  ...
  const TABS = [
    ...BASE_TABS,
    ...(user.role === 'admin' ? [{ id: 'admin', label: 'Admin', icon: <AdminIcon /> }] : []),
  ];
